...
-- SELECT item_id,position_x,position_y,position_z,camera_target_x,camera_target_y,camera_target_z,camera_position_x,camera_position_y,camera_position_z FROM item WHERE item_id ="' + dir + '";' -- Request coords
...
-- SELECT file_directory FROM item WHERE item_id =' + dir + '; -- basic item path request